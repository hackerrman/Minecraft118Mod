...
public class AlligatorGarRenderer extends GeoEntityRenderer<AlligatorGarEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(AlligatorGarEntity instance) {
        return new ResourceLocation(RiverMonsters.MOD_ID, "textures/entity/alligator_gar/alligator_gar.png");
    }

    @Override
    public RenderType getRenderType(AlligatorGarEntity animatable, float partialTicks, PoseStack stack,
