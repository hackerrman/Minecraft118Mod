...
public class GreenlandSharkEntity extends WaterAnimal implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);
    public GreenlandSharkEntity(EntityType<? extends WaterAnimal> entityType, Level level) {
        super(entityType, level);
        this.moveControl = new GreenlandSharkEntity.FishMoveControl(this);
    }
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        if(event.isMoving()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.greenlandshark.swim", true));
    ...
    static class FishSwimGoal extends RandomSwimmingGoal {
        private final GreenlandSharkEntity fish;

        public FishSwimGoal(GreenlandSharkEntity p_27505_) {
    ...
    static class FishMoveControl extends MoveControl {
        ...
        FishMoveControl(GreenlandSharkEntity p_27501_) {
            super(p_27501_);
            this.fish = p_27501_;
        }
